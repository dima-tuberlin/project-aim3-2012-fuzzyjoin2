...
import eu.stratosphere.fuzzyjoin.join.WordCount;
...
//	public TestA(Configuration config, String clusterConfig) {
...
//		MapContract<PactNull, PactString, PactString, PactInteger> mapContract = new MapContract<PactNull, PactString, PactString, PactInteger>(
//				TokenizeLine.class);
//
//		ReduceContract<PactString, PactInteger, PactString, PactInteger> reduceContract = new ReduceContract<PactString, PactInteger, PactString, PactInteger>(
//				CountWords.class);
//
...
//
//		// for (String line : readLines(Config.TEXT_DATA)) {
//		// testPlan.getInput().add(PactNull.getInstance(), new
//		// PactString(line));
//		// }
//
//		testPlan.getInput().add(new PactInteger(1), new PactString("test1"))
...
//		BufferedReader reader = new BufferedReader(new FileReader("./src/main/resources/dblpraw.txt"));
//		String line = "";
